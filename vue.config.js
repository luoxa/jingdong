      ...
      devServer:{
        ...
        before(app){
          ...
          app.get('/api/login',(req,res)=>{
            const {username,password}=req.query
            if(username=='admin' && password=='123456' || username=='superadmin' && password=='123456'){
              res.json({
                code:0,
                message:'登录成功',
            ...
            app.get('/api/banner',(req,res)=>{
              res.json({
                  data:[  {
                    ...
                    {
                      url: 'https://m.xdclass.net',
                      image: 'https://xd-video-pc-img.oss-cn-beijing.aliyuncs.com/xdclass_pro/bannner/1904/springcloud_banner.png'
                    },
                    {
                      url: 'https://m.xdclass.net',
